...
<html lang="en">
  <head>
    <title>Compruebe iniciar sesión y crear sesión</title>
...
<?php
	...
	*/
	if (password_verify($_POST['password'], $hash)) {	
		...
		//Here you can put more pages to go to.
		echo "<div class='alert alert-success' role='alert'><strong>¡Bienvenido!</strong> $row[Name]			
		<p><a href='edit-profile.php'>Editar Tablas</a></p>	
		<p><a href='logout.php'>Cerrar sesión</a></p></div>";	
	
	} else {
		echo "<div class='alert alert-danger' role='alert'>¡El e-mail o la contraseña son incorrectos!
